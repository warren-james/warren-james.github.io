...
:::{.callout-note}
Just wanted to highlight that I have many grievences with this approach, if that wasn't immediately clear. 
:::
...
Anyway, that's my understanding of survival analysis and the problems with applying logistic regression to censored data. Hopefully that's been interesting and helpful. When I have more concrete links, I'll add them to the bottom here, or maybe even make another post. 
